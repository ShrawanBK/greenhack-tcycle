...
export default function UserLogInScreen(props: any) {
    ...
    const [email, setEmail] = useState<string>('yishak@test.com');
    const [password, setPassword] = useState<string>('Yishakdfasdfs');
    ...
    const onLogInUser = useCallback(
        () => {
            ...
            const response: UserResponse = {
                ...
                location: 'Katajakatu, Finland',
                email: 'yishak@test.com',
            };
                    ...
                    <View style={styles.page}>
                        ...
                        <View
                            ...
                            <View>
                                ...
                                <Button
                                    onPress={() => console.warn('Forgot password pressed (WIP)')}
                                    transparent
                                >
                                    <Text style={{
