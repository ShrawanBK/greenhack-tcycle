...
export default function UserLogInScreen(props: any) {
    ...
    const onValidateForm = useCallback(
        (formKey: string, formValue: string) => {
            setFocusedField('');
            ...
            // NOTES - Can be internationalized
            ...
            if (formKey === 'location') {
                if (formValue.length < 2) {
                    setlocationError('Location is not valid.');
    ...
    const onRegisterUser = useCallback(
        () => {
            // NOTE : To be connected with Backend
                        ...
                        <View
                            ...
                            <View style={styles.formField}>
                                <Text
                                    style={[
                                        styles.formTitle,
                                        focusedField === 'location' ? { color: colors.primary } : {}
                                    ]}
                                >
                                    Location *
                                </Text>
                                <TextInput
                                    ...
                                    selectionColor="#6373db"
                                    clearTextOnFocus={true}
                                    onEndEditing={(event) => onValidateForm('location', event.nativeEvent.text)}
                                    style={styles.formContent}
                                    keyboardType="phone-pad"
                                />
                                {
